...
void Display(void)
{
	static float fElect1 = 0.0f;           // 绕太阳旋转的角度
	static float fElect2 = 0.0f;           // 绕地球旋转的角度
