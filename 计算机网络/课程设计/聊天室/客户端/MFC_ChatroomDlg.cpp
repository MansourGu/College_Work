...
// MFC_ChatroomDlg.cpp: 实现文件
//
#pragma once
#include "pch.h"
#include "framework.h"
#include "MFC_Chatroom.h"
#include "MFC_ChatroomDlg.h"
...
CMFCChatroomDlg::CMFCChatroomDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFC_CHATROOM_DIALOG, pParent)
{
...
void CMFCChatroomDlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	EndDialog(0);
	Username.UpdateData(false);
	CString username_value;
	GetDlgItemText(IDC_username , username_value);
	Dlg1 dlg;
	dlg.username_value = username_value;
	dlg.DoModal();
}